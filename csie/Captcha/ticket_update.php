...
while($row=$rs->fetch()){
	...
	echo "<tr><td>乘車日期<td>$row[mydate]<td><input type='date' name='mydate' value=$row[mydate]>";
    echo "<tr><td>車次<td>$row[trainno]<td><input type='text' name='trainno' value=$row[trainno]>";
